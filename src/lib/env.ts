...
const serverSchema = z.object({
  ...
  /**
   * Подписывает сессию администратора. Ни для чего другого не используется:
   * у каждого секрета одна задача (docs/03 п.11.1, правило 5).
   * Без него админка не работает, сайт — работает.
   */
